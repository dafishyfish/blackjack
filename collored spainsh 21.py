...
def play_blackjack(num_decks):
    ...
    print(f'Dealers hand: {yellow} {dealer_hand[0]} and [Hidden]:')
    ...
    while hand_value(dealer_hand) < 17:
        ...
        if hand_value(dealer_hand) > 21:
            print(f'{green}:Dealer busts! Player wins.')
            return
    ...
    if player_value > dealer_value:
        print(f'{green}:Player wins!')
    elif player_value < dealer_value:
        print(f'{red}:Dealer wins!')
    else:
        print("It's a tie!")
        
        
  # Run the game with 8 decks
play_blackjack(8)
